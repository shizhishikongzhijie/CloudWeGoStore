...
type Echo interface {
	Echo(ctx context.Context, r_ *Request) (r *Response, err error)
}
...
func (p *EchoClient) Echo(ctx context.Context, r_ *Request) (r *Response, err error) {
...
func (p *echoProcessorEcho) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	...
	var retval *Response
	if retval, err2 = p.handler.Echo(ctx, args.R); err2 != nil {
...
type EchoEchoArgs struct {
	R *Request `thrift:"r,1" frugal:"1,default,Request" json:"r"`
}
...
var EchoEchoArgs_R_DEFAULT *Request

func (p *EchoEchoArgs) GetR() (v *Request) {
	if !p.IsSetR() {
		return EchoEchoArgs_R_DEFAULT
	}
	return p.R
}
func (p *EchoEchoArgs) SetR(val *Request) {
	p.R = val
}
...
func (p *EchoEchoArgs) IsSetR() bool {
	return p.R != nil
}
